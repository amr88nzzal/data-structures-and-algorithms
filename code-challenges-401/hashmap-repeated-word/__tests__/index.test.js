...
describe('test repeatedWord function', () => {
  ...
  it('1)- should successfully output the first repeated word from the string', () => {
    expect(repeatedWord(Input1)).toEqual('a');
  });

  it('2)- should successfully output the first repeated word from the string', () => {
    expect(repeatedWord(Input2)).toEqual('it');
  });

  it('3)- should successfully output the first repeated word from the string', () => {
    expect(repeatedWord(Input3)).toEqual('summer');
  });
});