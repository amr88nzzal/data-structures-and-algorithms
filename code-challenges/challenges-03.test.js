...
const typeNum = (arr) => {
  // Solution code here...
  const newArr = arr.filter(x=>!isNaN(x));
  return newArr;
};
/* ------------------------------------------------------------------------------------------------
CHALLENGE 3
...
const containsAnd = (arr) => {
  // Solution code here...
  const newArr=arr.filter(str=>str.search('and')>-1);
  return newArr;
};
...
const oddValues = (arr) => {
  // Solution code here...
  const newArr= arr.filter(odd=>odd%2!==0);
  return newArr;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  const newArr = arr.filter(x=>!forbiddenValues.includes(x));
  return newArr;
};
